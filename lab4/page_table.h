...
typedef struct {
    ...
    unsigned valid : 1; // if the user program attempts to write to the page when valid==0, 
    					//the requested_page field in the page_table will be set to the index of this page_table_entry, and the SIGUSR1 signal will be raised to your OS simulator.
